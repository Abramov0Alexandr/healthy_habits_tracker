...
from habits.validators import DurationValidator, InitialInstanceFieldsValidator
...
class HabitsCreateSerializers(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if related_habit_data:
            ...
            # Создаем связанную привычку только в нужных случаях
